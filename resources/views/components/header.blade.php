    ...
    <div class="container flex justify-between items-center relative px-4">
        ...
        <ul class="xl:flex hidden">
            <li class="relative group">
                <a class="menu-item" href="{{ url('/') }}">Beranda</a>
                <ul
                    class="z-100 absolute px-6 py-4 rounded-md left-4 bg-neutral-0 dark:bg-neutral-dark-0 min-w-48 shadow-sm mt-8 opacity-0 invisible group-hover:opacity-100 group-hover:visible group-hover:mt-4 transition-all duration-500">
                    <li><a href="{{ url('/') }}" class="menu-sub-item">Home page 01</a></li>
                    <li><a href="index-2.html" class="menu-sub-item">Home page 02</a></li>
                    <li><a href="index-3.html" class="menu-sub-item">Home page 03</a></li>
                </ul>
            </li>
            <li class="relative group">
                <a class="menu-item" href="#">Profil Desa</a>
                <ul
                    class="z-100 absolute px-6 py-4 rounded-md left-4 bg-neutral-0 dark:bg-neutral-dark-0 min-w-48 shadow-sm mt-8 opacity-0 invisible group-hover:opacity-100 group-hover:visible group-hover:mt-4 transition-all duration-500">
                    <li><a href="category.html" class="menu-sub-item">Profil Desa</a></li>
                </ul>
            </li>
            <li class="relative group">
                <a class="menu-item" href="#">Informasi</a>
                <ul
                    class="z-100 absolute px-6 py-4 rounded-md left-4 bg-neutral-0 dark:bg-neutral-dark-0 min-w-48 shadow-sm mt-8 opacity-0 invisible group-hover:opacity-100 group-hover:visible group-hover:mt-4 transition-all duration-500">
                    <li><a href="page-about.html" class="menu-sub-item">About me</a></li>
                </ul>
            </li>
            <li class="group">
                <a href="#" class="menu-item group-hover:border-white">Potensi Desa</a>
                <!-- MEGA MENU CONTENT -->
                <div
                    class="w-full px-12 py-12 rounded-2xl bg-neutral-0 dark:bg-neutral-dark-0 shadow-sm absolute top-full left-0 mt-8 opacity-0 invisible group-hover:opacity-100 group-hover:visible group-hover:mt-4 transition-all duration-500">
                    <h3 class="text-5xl mb-8 text-neutral-950 dark:text-neutral-dark-950">Featured <span
                            class="font-bold">Posts</span></h3>
                        ...
                        <div class="flex flex-col gap-4">
                            <div class="flex gap-6 content-center hover-up">
                                ...
                                <div class="flex flex-col gap-3">
                                    <a class="text-base font-bold text-neutral-950 dark:text-neutral-dark-950"
                                        href="single.html">
        ...
        <div class="flex justify-end align-middle content-center items-center relative gap-4">
            <div class="language-switcher py-4 relative z-10">
                ...
                <div class="relative size-6 z-10">
                    <div
                        class="language absolute inline-flex flex-col gap-[2px] overflow-hidden min-w-32 h-[24px] top-0 left-0">
                        <div class="language__el bg-neutral-0 dark:bg-neutral-dark-0 cursor-pointer is-active "
                            data-lang="en">
            ...
            <div class="search-box flex relative py-4 z-20">
                ...
                <div
                    class="search-box-content absolute top-full right-0 p-10  mr-[-50px] max-w-[360px] md:max-w-none bg-neutral-0 dark:bg-neutral-dark-200 rounded-2xl shadow-sm hidden invisible mt-8 transition-all duration-300">
                    ...
                    <div class="relative mb-8">
                        <form action="">
                            <div
                                ...
                                <input
                                    class="flex-1 focus:outline-none transition duration-200 bg-transparent max-w-[175px] md:max-w-none"
                                    type="text" placeholder="Enter your key words">
                                <button
                                    class="min-w-12 size-12 rounded-full bg-primary-light-950 transition duration-200 flex items-center justify-center gap-2"
                                    type="submit">
            ...
            <button class="navbar-burger self-center xl:hidden">
                <svg class="fill-neutral-950 dark:fill-neutral-dark-950" id="fi_2976215"
                    ...
                    <div class="flex flex-col h-full">
                        ...
                        <ul class="py-6 mb-6 border-y border-neutral-300 dark:border-neutral-dark-300">
                            <li class="has-children">
                                ...
                                <ul class="sub-menu">
                                    <li><a class="menu-mobile-sub-item" href="{{ url('/') }}">Home page 01</a>
                                    </li>
                                    <li><a class="menu-mobile-sub-item" href="index-2.html">Home page 02</a></li>
                                    <li><a class="menu-mobile-sub-item" href="index-3.html">Home page 03</a></li>
                                </ul>
                            </li>
                            <li class="has-children">
                                <a class="menu-mobile-item" href="#">Blog</a>
                                <ul class="sub-menu">
                                    <li><a href="category.html" class="menu-mobile-sub-item">Category 01</a></li>
                                    <li><a href="category-2.html" class="menu-mobile-sub-item">Category 02</a></li>
                                    <li><a href="category-3.html" class="menu-mobile-sub-item">Category 03</a></li>
                                    <li><a href="category-4.html" class="menu-mobile-sub-item">Category 04</a></li>
                                    <li><a href="single.html" class="menu-mobile-sub-item">Single 01</a></li>
                                    <li><a href="single-2.html" class="menu-mobile-sub-item">Single 02</a></li>
                                </ul>
                            </li>
                            <li class="has-children">
                                <a class="menu-mobile-item" href="#">Pages</a>
                                <ul class="sub-menu">
                                    <li><a href="page-about.html" class="menu-mobile-sub-item">About me</a></li>
                                    <li><a href="page-author.html" class="menu-mobile-sub-item">Author</a></li>
                                    <li><a href="page-search.html" class="menu-mobile-sub-item">Search Results</a>
                                    </li>
                                    <li><a href="page-contact.html" class="menu-mobile-sub-item">Contact</a></li>
                                    <li><a href="page-login.html" class="menu-mobile-sub-item">Login</a></li>
                                    <li><a href="page-register.html" class="menu-mobile-sub-item">Register</a></li>
                                    <li><a href="page-forgot-password.html" class="menu-mobile-sub-item">Forgot
                                            Password</a></li>
                                    <li><a href="page-404.html" class="menu-mobile-sub-item">Error 404</a></li>
                                </ul>
                            </li>
                            <li><a class="menu-mobile-item" href="page-about.html">About</a></li>
                            <li><a class="menu-mobile-item" href="page-contact.html">Contact</a></li>
                        </ul>
                        <div class="flex flex-wrap flex-col mt-4">
                            <h4 class="text-lg text-neutral-950 dark:text-neutral-dark-950 font-bold mb-4">Stay
                                Connectted</h4>
                            <p class="text-sm text-neutral-700 font-medium mb-4 leading-5">Imagine waking up to a dose
                                of positivity, lifestyle hacks, and inspiration tailored just for you. That's what you
                                get when you subscribe!</p>
                            <a href="page-login.html"
                                class="w-full p-4 text-neutral-950 bg-primary-light-950 rounded-md font-bold text-sm">Subscribe
                                Now</a>
                        </div>
                    </div>
                </nav>
