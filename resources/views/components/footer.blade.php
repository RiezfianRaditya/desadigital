    ...
    <div class="container px-4">
        ...
        <div class="grid lg:grid-cols-2">
            <div class="mb-8 lg:mb-4 lg:max-w-96">
                <h1 class="mb-8">
                    <a href="index.html">
                        <img src="assets/photo/logo-desa.png" alt="logo" class="shrink-0 relative dark:hidden">
                        <img src="assets/photo/logo-desa.png" alt="logo"
                ...
                <p class="font-medium text-neutral-950 dark:text-neutral-dark-950 mb-8 lg:mb-12 max-w-[350px]">
                    Lirung Ubing adalah salah satu kampung di Kecamatan Long Pahagai, Kabupaten Mahakam Ulu, Provinsi
                    ...
                    <ul>
                        <li class="footer-menu">
                            <a href="category.html"
                                class="text-base font-regular text-neutral-950 dark:text-neutral-dark-950">Profil
                                desa</a>
                        </li>
                        <li class="footer-menu">
                            <a href="category-2.html"
                                class="text-base font-regular text-neutral-950 dark:text-neutral-dark-950">Informasi</a>
                        </li>
                        <li class="footer-menu">
                            <a href="category-3.html"
                                class="text-base font-regular text-neutral-950 dark:text-neutral-dark-950">Berita</a>
                        </li>
                        <li class="footer-menu">
                            <a href="category-4.html"
                                class="text-base font-regular text-neutral-950 dark:text-neutral-dark-950">Potensi
                                Desa</a>
                        </li>
                    </ul>
                </div>
                <div class="mb-4">
                    <h6 class="text-base font-bold text-neutral-700 dark:text-neutral-dark-700 mb-2">Layanan</h6>
                    <ul>
                        <li class="footer-menu">
                        ...
                        <li class="footer-menu">
                            <a href="page-contact.html"
                                class="text-base font-regular text-neutral-950 dark:text-neutral-dark-950">Status
                                Desa</a>
                        </li>
                        <li class="footer-menu">
                            <a href="page-author.html"
                                class="text-base font-regular text-neutral-950 dark:text-neutral-dark-950">Layanan
                                Mandiri</a>
                        </li>
                        <li class="footer-menu">
                            <a href="page-search.html"
                                class="text-base font-regular text-neutral-950 dark:text-neutral-dark-950">Lembaga
                                Desa</a>
                        </li>
                    </ul>
                </div>
                <div class="mb-4">
                    <h6 class="text-base font-bold text-neutral-700 dark:text-neutral-dark-700 mb-2">Statistik</h6>
                    <ul>
                        <li class="footer-menu">
                            <a href="page-register.html"
                                class="text-base font-regular text-neutral-950 dark:text-neutral-dark-950">Galerry</a>
                        </li>
                        <li class="footer-menu">
                            <a href="page-login.html"
                                class="text-base font-regular text-neutral-950 dark:text-neutral-dark-950">Login</a>
                        </li>
                        <li class="footer-menu">
                            <a href="page-forgot-password.html"
                                class="text-base font-regular text-neutral-950 dark:text-neutral-dark-950">Forgot
                                Password</a>
                        </li>
                        <li class="footer-menu">
                            <a href="page-404.html"
                                class="text-base font-regular text-neutral-950 dark:text-neutral-dark-950">404</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="pt-8">
            <p class="text-sm text-neutral-700 dark:text-neutral-dark-700">© Desa Lirung Ubing <a
                    href="https://alithemes.com" class="text-neutral-950 dark:text-neutral-dark-950">Long Pahangai -
                    Mahakam Ulu</a></p>
        </div>
    </div>
</footer>
