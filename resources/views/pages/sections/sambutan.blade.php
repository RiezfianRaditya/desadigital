<section class="py-12">
    <div class="container px-4">
        <div
            class="w-full rounded-[26px] bg-gradient-to-t from-primary-light-950 via-primary-light-300 to-primary-light-200 p-1.5">
            <div
                class="flex flex-col md:flex-row rounded-[21px] h-full w-full items-center justify-center bg-neutral-0 dark:bg-neutral-dark-0 back p-2 md:p-2 lg:p-16">
                <div class="md:pr-16 md:min-w-72 lg:min-w-96 rounded-3xl overflow-hidden">
                    <img class="rounded-3xl md:min-w-96" src="assets/photo/prabowo.png" alt="">
                </div>
                <div class="p-2 md:p-2 lg:py-12 md:pl-8 lg:pl-16">
                    <h3 class="heading-3 mb-4">Prabowo Subianto</h3>
                    <p class="text-neutral-950 dark:text-neutral-dark-950 text-base font-medium lg:max-w-[810px]">
                        Website ini adalah "jendela" baru bagi kami. Sebuah cara untuk menjembatani kearifan masa lalu
                        dengan dunia masa kini. Melalui layar ini, kami ingin berbagi cerita, keindahan alam, dan
                        kekayaan budaya yang kami jaga dengan sepenuh hati. Kami ingin dunia tahu bahwa jauh di jantung
                        Kalimantan, ada sebuah komunitas yang hidup dalam harmoni, kesederhanaan, dan memegang teguh
                        warisan leluhur.</p>
                    <div class="flex gap-2 mt-12">
                        ...
                        <a
                            class="h-12 px-4 rounded-[5px] flex justify-center items-center bg-primary-light-950 dark:bg-primary-dark-950 cursor-pointer hover-up text-neutral-950 dark:text-neutral-dark-950 text-xl font-medium">
                            Follow
                        </a>
                    </div>
                </div>
