    ...
    <div class="container px-4">
        <div class="flex flex-col gap-8 items-center justify-center text-center">
            <h1 class="heading-1 mb-0">
                Event <span class="font-light">Desa</span>
            </h1>
            <p class="text-base md:text-lg font-medium text-neutral-950 dark:text-neutral-dark-950 max-w-3xl">Berbagai
                event dan kegiatan terupdate dari desa akan tampil disini </p>
        </div>
    </div>
</section>
            ...
            <div class="flex-col justify-start items-start gap-5 inline-flex hover-up">
                ...
                <div class="flex-col justify-start items-start gap-3.5 flex">
                    ...
                    <p
                        ...
                        chaos and harmony. As we navigate the intricate landscapes of inspiration, we unravel the
