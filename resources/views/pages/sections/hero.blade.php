<section class="relative py-20 lg:py-24 lg:mb-16">
    <div class="container px-4">
        <h1 class="heading-1">Lirung Ubing, <span class="font-light">Long Pahangai - Mahakam Ulu</span></h1>
            ...
            <div class="swiper-wrapper pt-4">
                <div class="swiper-slide hover-up">
                    <div class="w-full h-52 relative rounded-3xl overflow-hidden">
                        <a href="{{ url('/') }}"><img class="left-0 top-0 absolute rounded-3xl"
                                src="assets/photo/hero-1.png" style="height: 210px" /></a>
                        <div class="px-[13px] py-[9px] left-[10px] top-[150px] absolute bg-neutral-0 dark:bg-neutral-dark-0 rounded-[26px] justify-center items-center gap-2.5 inline-flex"
                            ...
                            <a href="{{ url('/') }}"
                                class="text-neutral-950 dark:text-neutral-dark-950 text-sm font-medium">ini adalah judul
                                kegiatan yang bisa di klik dan dilihat </a>
                        </div>
                    </div>
                </div>
                <div class="swiper-slide hover-up">
                    <div class="w-full h-52 relative rounded-3xl overflow-hidden">
                        <a href="{{ url('/') }}"><img class="left-0 top-0 absolute rounded-3xl"
                                src="assets/photo/hero-2.png" style="height: 210px" /></a>
                        <div class="px-[13px] py-[9px] left-[10px] top-[150px] absolute bg-neutral-0 dark:bg-neutral-dark-0 rounded-[26px] justify-center items-center gap-2.5 inline-flex"
                            style="margin-right: 10px;">
                            <a href="{{ url('/') }}"
                                class="text-neutral-950 dark:text-neutral-dark-950 text-sm font-medium">ini adalah judul
                ...
                <div class="swiper-slide hover-up">
                    <div class="w-full h-52 relative rounded-3xl overflow-hidden">
                        <a href="{{ url('/') }}"><img class="left-0 top-0 absolute rounded-3xl"
                                src="assets/photo/hero-3.png" style="height: 210px" /></a>
                        <div class="px-[13px] py-[9px] left-[10px] top-[150px] absolute bg-neutral-0 dark:bg-neutral-dark-0 rounded-[26px] justify-center items-center gap-2.5 inline-flex"
                            style="margin-right: 10px;">
                            <a href="{{ url('/') }}"
                                class="text-neutral-950 dark:text-neutral-dark-950 text-sm font-medium">ini adalah judul
                ...
                <div class="swiper-slide hover-up">
                    <div class="w-full h-52 relative rounded-3xl overflow-hidden">
                        <a href="{{ url('/') }}"><img class="left-0 top-0 absolute rounded-3xl"
                                src="assets/photo/hero-4.png" style="height: 210px" /></a>
                        <div class="px-[13px] py-[9px] left-[10px] top-[150px] absolute bg-neutral-0 dark:bg-neutral-dark-0 rounded-[26px] justify-center items-center gap-2.5 inline-flex"
                            style="margin-right: 10px;">
                            <a href="{{ url('/') }}"
                                class="text-neutral-950 dark:text-neutral-dark-950 text-sm font-medium">ini adalah judul
                ...
                <div class="swiper-slide hover-up">
                    <div class="w-full h-52 relative rounded-3xl overflow-hidden">
                        <a href="{{ url('/') }}"><img class="left-0 top-0 absolute rounded-3xl"
                                src="assets/photo/hero-5.png" style="height: 210px" /></a>
                        <div class="px-[13px] py-[9px] left-[10px] top-[150px] absolute bg-neutral-0 dark:bg-neutral-dark-0 rounded-[26px] justify-center items-center gap-2.5 inline-flex"
                            style="margin-right: 10px;">
                            <a href="{{ url('/') }}"
                                class="text-neutral-950 dark:text-neutral-dark-950 text-sm font-medium">ini adalah judul
        ...
        <div class="flex justify-between items-center gap-8 lg:gap-32 mt-12 flex-col lg:flex-row">
            <p class="text-neutral-950 dark:text-neutral-dark-950 text-base font-medium lg:w-2/4">Lirung Ubing adalah
                salah satu kampung di Kecamatan Long Pahagai, Kabupaten Mahakam Ulu, Provinsi Kalimantan Timur,
                Indonesia.</p>
    ...
    <div
        class="header-bg absolute bottom-0 left-0 right-0 -z-50 w-full h-full bg-gradient-to-t from-primary-light-950/15 to-transparent">
    </div>
</section>
