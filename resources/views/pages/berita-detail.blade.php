        ...
        <div class="container px-4">
            <div class="flex w-full justify-center item-center mb-16">
                ...
                <div
                    ...
                    <a href="index.html"
                        class="text-neutral-700 dark:text-neutral-dark-700 text-base font-medium  leading-normal">Home</a>
                    ...
                    <a href="category.html"
                        class="text-neutral-700 dark:text-neutral-dark-700 text-base font-medium leading-normal">Blog</a>
                    <svg xmlns="http://www.w3.org/2000/svg" width="8" height="12" viewBox="0 0 8 12"
                        class="fill-neutral-700 dark:fill-neutral-dark-700">
                        <path
                            d="M1.52344 11.9961C1.24219 11.9961 0.992188 11.9023 0.804688 11.7148C0.398438 11.3398 0.398438 10.6836 0.804688 10.3086L5.08594 5.99609L0.804688 1.71484C0.398438 1.33984 0.398438 0.683594 0.804688 0.308594C1.17969 -0.0976562 1.83594 -0.0976562 2.21094 0.308594L7.21094 5.30859C7.61719 5.68359 7.61719 6.33984 7.21094 6.71484L2.21094 11.7148C2.02344 11.9023 1.77344 11.9961 1.52344 11.9961Z" />
                    </svg>
                    <span class="text-neutral-900 dark:text-neutral-dark-950 text-base font-bold leading-snug">Ini adalah
                        judul dari berita </span>
                </div>
            </div>
            <div class="flex flex-col gap-4 items-center justify-center text-center">
                <div class="justify-center items-center gap-4 flex flex-col md:flex-row">
                    <a href="category.html"
                        ...
                        <span
                            class="text-neutral-900 dark:text-neutral-dark-950 text-sm font-medium leading-none">Technology</span>
                    </a>
                    <div class="justify-start items-center gap-2 flex">
                        <a href="author.html"><img class="w-9 h-9 rounded-3xl"
                                src="{{ url('') }}/assets/imgs/avatar/avatar-10.png" /></a>
                        <div class="text-neutral-700 text-sm font-medium leading-none dark:text-neutral-dark-700"><a
                                href="author.html">M. Azumi</a> - 28 January 2014</div>
                    </div>
                </div>
                <h1
                    class="text-4xl lg:text-6xl font-bold text-neutral-950 dark:text-neutral-dark-950 max-w-5xl leading-snug">
                    Ini adalah judul dari berita
                </h1>
                <p class="text-base md:text-lg font-medium text-neutral-950 dark:text-neutral-dark-950 max-w-3xl">Ini adalah
                    sub title dari berita yang akan tampil disini</p>
            </div>
        </div>
    </section>
    <!-- Single 1 Section 2 -->
            ...
            <div class="flex flex-col lg:flex-row justify-between gap-[58px]">
                <div class="post-content max-w-[850px]">
                    ...
                    <div
                        ...
                        <img src="{{ url('') }}/assets/photo/hero-5.png" class="rounded-3xl mb-8" alt=""
                            width="100%">
                        <p class="mb-4">In the grand tapestry of existence, the journey of life unfolds through the lens
                            of creativity, where each individual becomes an artist, contributing unique brushstrokes to the
                            canvas of existence.</p>

                        <p>In the vast canvas of existence, each individual carries within themselves a unique palette of
                            experiences, emotions, and aspirations. This intricate tapestry, woven with the threads of life,
                            becomes the backdrop for an extraordinary journey – a journey where creativity takes center
                            stage. "Brushstrokes of Life: A Creative Journey Unveiled" is an exploration into the boundless
                            realms of human imagination and expression.</p>
                        ...
                        <p>At its core, creativity is the manifestation of the human spirit, a vivid portrayal of the myriad
                            hues that define our existence. This journey begins with the first strokes of infancy, where
                            curiosity and wonder lay the foundation for the artist within. As we traverse the landscapes of
                            childhood, adolescence, and adulthood, our experiences become the pigments that color our
                            canvases.</p>
                        ...
                        <blockquote class="block-quote relative pt-8 pb-8 pl-20 overflow-hidden mb-4">
                            <svg xmlns="http://www.w3.org/2000/svg" width="49" height="36" viewBox="0 0 49 36"
                                class="fill-primary-light-950 dark:fill-primary-dark-950 opacity-20 absolute top-8 left-0">
                                <path
                                    d="M10.5 0.5C16.2969 0.5 21 5.20312 21 11V21.5C21 29.2656 14.6562 35.5 7 35.5C5.03125 35.5 3.5 33.9688 3.5 32C3.5 30.1406 5.03125 28.5 7 28.5C10.8281 28.5 14 25.4375 14 21.5V20.9531C12.7969 21.2812 11.7031 21.5 10.5 21.5C4.59375 21.5 0 16.9062 0 11C0 5.20312 4.59375 0.5 10.5 0.5ZM49 11V21.5C49 29.2656 42.6562 35.5 35 35.5C33.0312 35.5 31.5 33.9688 31.5 32C31.5 30.1406 33.0312 28.5 35 28.5C38.8281 28.5 42 25.4375 42 21.5V20.9531C40.7969 21.2812 39.7031 21.5 38.5 21.5C32.5938 21.5 28 16.9062 28 11C28 5.20312 32.5938 0.5 38.5 0.5C44.2969 0.5 49 5.20312 49 11Z"
                                    fill="#FFCF01" />
                            </svg>
                            <span class="font-normal text-xl block mb-4">Within the strokes of our existence, creativity is
                                the heartbeat that transforms the mundane into a masterpiece, revealing the extraordinary
                                tapestry of our shared human journey</span>
                            <cite>-- Emily Jane</cite>
                        </blockquote>

                        <p>The creative journey is a dynamic process, evolving with every stroke, akin to an artist refining
                            their masterpiece. It encapsulates the courage to embrace vulnerability and the resilience to
                            learn from failures. Each brushstroke signifies a lesson learned, a challenge overcome, and a
                            moment of self-discovery. These strokes are not merely about creating art; they are about
                            forging connections with our inner selves and the world around us.</p>
                        ...
                        <p>The canvas of life is vast, encompassing various forms of creativity – be it in the realms of
                            ...
                            ability to innovate, adapt, and transform mundane moments into extraordinary expressions. The
                            dance of creativity unfolds differently for each person, and the beauty lies in the diversity of
                            perspectives and interpretations.</p>

                        <div class="grid md:grid-cols-2 gap-4 mt-8">
                            <img src="{{ url('') }}/assets/photo/img-19.png" class="rounded-3xl mb-8" alt="">
                            <img src="{{ url('') }}/assets/photo/img-24.png" class="rounded-3xl mb-8" alt="">
                        </div>

                        <p>Creativity also serves as a powerful tool for introspection and societal reflection. It has the
                            capacity to challenge norms, break barriers, and build bridges. The unveiling of this creative
                            journey is not just a personal revelation but a shared experience that resonates with others,
                            fostering a sense of collective understanding and empathy.</p>
                        <h5>The Multifaceted Nature of Creativity</h5>

                        <p>As we navigate the twists and turns of our creative odyssey, it becomes apparent that the canvas
                            is not static. It is a living, breathing entity that mirrors our growth, evolution, and the
                            ever-changing landscapes of our emotions. Embracing the impermanence of the canvas allows us to
                            appreciate the beauty in each fleeting moment, savoring the essence of our creative endeavors.
                        </p>
                        ...
                        <div class="flex flex-col md:flex-row justify-between gap-8">
                            <div>
                                ...
                                <div class="flex flex-wrap gap-2">
                                    <a href="category.html"
                                        class="hover-up px-5 py-2 rounded-full border border-neutral-300 dark:border-neutral-dark-300  text-base font-medium hover:bg-neutral-300  hover:dark:bg-neutral-dark-300 transition-all duration-300">Art</a>
                                    <a href="category-2.html"
                                        class="hover-up px-5 py-2 rounded-full border border-neutral-300 dark:border-neutral-dark-300  text-base font-medium hover:bg-neutral-300  hover:dark:bg-neutral-dark-300 transition-all duration-300">Fashion</a>
                                    <a href="category-3.html"
                                        class="hover-up px-5 py-2 rounded-full border border-neutral-300 dark:border-neutral-dark-300  text-base font-medium hover:bg-neutral-300  hover:dark:bg-neutral-dark-300 transition-all duration-300">Health</a>
                                    <a href="category-4.html"
                                        class="hover-up px-5 py-2 rounded-full border border-neutral-300 dark:border-neutral-dark-300  text-base font-medium hover:bg-neutral-300  hover:dark:bg-neutral-dark-300 transition-all duration-300">Food</a>
                                </div>
                            </div>
                            <div>
                    ...
                    <div class="relative single-comment-form mt-20 max-w-[850px]">
                        ...
                        <form action="">
                            ...
                            <div class="flex items-center mb-8">
                                ...
                                <label for="save-info" class="text-sm text-neutral-950 dark:text-neutral-dark-950">Save my
                                    name, email, and website in this browser for the next time</label>
                            </div>
                            <button type="submit"
                        ...
                        <div class="flex flex-col gap-6">
                            <div class="w-full flex items-center gap-2.5  hover-up">
                                <div class="justify-start items-center gap-4 inline-flex">
                                    <a href="single.html" class="rounded-2xl overflow-hidden max-h-[90px] max-w-[106px]">
                                        <img src="{{ url('') }}/assets/photo/hero-1.png" />
                                    </a>
                            ...
                            <div class="w-full flex items-center gap-2.5  hover-up">
                                <div class="justify-start items-center gap-4 inline-flex">
                                    <a href="single.html" class="rounded-2xl overflow-hidden max-h-[90px] max-w-[106px]">
                                        <img src="{{ url('') }}/assets/photo/hero-2.png" />
                                    </a>
                                    <div class="flex-col justify-start items-start gap-4 inline-flex">
                                        <h4>
                                            <a class="text-neutral-950 dark:text-neutral-dark-950 text-base font-bold item-link"
                                                href="single.html">Tech Threads and Culinary Canvas: Lifestyle Palette</a>
                                        </h4>
                                        <p
                                            class="text-neutral-700 text-sm font-medium leading-none dark:text-neutral-dark-700">
                            ...
                            <div class="w-full flex items-center gap-2.5  hover-up">
                                <div class="justify-start items-center gap-4 inline-flex">
                                    <a href="single.html" class="rounded-2xl overflow-hidden max-h-[90px] max-w-[106px]">
                                        <img src="{{ url('') }}/assets/photo/hero-3.png" />
                                    </a>
                                    <div class="flex-col justify-start items-start gap-4 inline-flex">
                                        <h4>
                                            <a class="text-neutral-950 dark:text-neutral-dark-950 text-base font-bold item-link"
                                                href="single.html">Living the Art-Tech Dream: My Multifaceted Life</a>
                                        </h4>
                                        <p
                                            class="text-neutral-700 text-sm font-medium leading-none dark:text-neutral-dark-700">
                            ...
                            <div class="w-full flex items-center gap-2.5  hover-up">
                                <div class="justify-start items-center gap-4 inline-flex">
                                    <a href="single.html" class="rounded-2xl overflow-hidden max-h-[90px] max-w-[106px]">
                                        <img src="{{ url('') }}/assets/photo/hero-4.png" />
                                    </a>
                                    <div class="flex-col justify-start items-start gap-4 inline-flex">
                                        <h4>
                                            <a class="text-neutral-950 dark:text-neutral-dark-950 text-base font-bold item-link"
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        <div class="w-72 h-96 relative rounded-2xl">
                            <img class="w-72 h-96 left-0 top-0 absolute rounded-2xl"
                                src="{{ url('') }}/assets/photo/hero-5.png" />
                            <div
        ...
        <div class="container px-4">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-[30px]">
                <div
                    ...
                    <a href="single.html" class="rounded-2xl overflow-hidden max-h-[180px]">
                        <img src="{{ url('') }}/assets/photo/hero-2.png" />
                    </a>
                ...
                <div
                    class="flex-col justify-start items-start gap-5 inline-flex hover-up border-2 border-neutral-300 dark:border-neutral-dark-300 rounded-3xl overflow-hidden">
                    <a href="single.html" class="rounded-2xl overflow-hidden max-h-[180px]">
                        <img src="{{ url('') }}/assets/photo/hero-5.png" />
                    </a>
                    <div class="flex-col justify-start items-start gap-3.5 flex px-4 pb-4">
                        <div class="justify-start items-center gap-5 inline-flex">
                            <a href="category.html"
